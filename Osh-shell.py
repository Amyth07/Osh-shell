...
def execute_command(command):
    ...
    try:
        if "|" in command:
            ...
            s_in, s_out = (0, 0)
            s_in = os.dup(0)                #return a duplicate of file descriptor
            s_out = os.dup(1)
            ...
            for cmd in command.split("|"):
                ...
                os.dup2(fdin, 0)                #duplicating fdin file descriptor as 0 if available
                os.close(fdin)
                ...
                if cmd == command.split("|")[-1]:
                    ...
                    fdin, fdout = os.pipe()              #creates a pipe and returns a pair of file descriptors (r, w)
